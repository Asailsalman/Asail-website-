...
exports.handler = async function(event) {
  ...
  <div style="margin:0;padding:0;background:#f7f6f2;color:#111;font-family:Arial,sans-serif;line-height:1.65">
    <div style="max-width:680px;margin:auto;background:#fff;padding:38px 32px;border:1px solid #ece8e0">
      ...
      <h1 style="font-family:Georgia,serif;font-weight:400;font-size:34px;line-height:1.1;margin:0 0 18px">Weâve received your request.</h1>
      <p>Dear ${name},</p>
      ...
      <div dir="rtl" style="text-align:right;font-family:Tahoma,Arial,sans-serif;border-top:1px solid #eee;margin-top:28px;padding-top:24px">
        <h2 style="font-weight:400;margin:0 0 12px">ØªÙ Ø§Ø³ØªÙØ§Ù Ø·ÙØ¨ÙÙ Ø¨ÙØ¬Ø§Ø­.</h2>
        <p>Ø´ÙØ±ÙØ§ ÙØªÙØ§ØµÙÙÙ ÙØ¹ Ø£ØµØ§ÙÙ Ø§ÙØ±ÙÙØ¨Ø¹Ù. Ø·ÙØ¨ÙÙ Ø§ÙØ¢Ù ÙÙØ¯ Ø§ÙÙØ±Ø§Ø¬Ø¹Ø© Ø§ÙØ£ÙÙÙØ©Ø ÙØ³ÙØªÙ ØªØ²ÙÙØ¯ÙÙ Ø¨ÙØ·Ø§Ù Ø§ÙØ¹ÙÙ ÙØ¹Ø±Ø¶ Ø§ÙØ³Ø¹Ø± ÙØ§ÙØ®Ø·ÙØ§Øª Ø§ÙØªØ§ÙÙØ© ÙØ¨Ù Ø§ÙØ¨Ø¯Ø¡ Ø¨Ø£Ù Ø®Ø¯ÙØ©.</p>
        <p><b>Ø±ÙÙ Ø§ÙØ·ÙØ¨:</b> ${no}</p>
      </div>
  ...
  try {
    ...
    try {
      await sendEmail(apiKey, {
        ...
        subject: `Weâve received your legal request â ${no}`,
        html: clientHtml
      });
